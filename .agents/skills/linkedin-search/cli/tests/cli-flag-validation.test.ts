...
describe("LinkedIn CLI flag validation", () => {
  describe("numeric flag validation", () => {
    ...
    test.skipIf(process.env.JOB_SEARCH_LIVE_TESTS !== "1")("valid integer passes validation", async () => {
  ...
  describe("existing validations (regression)", () => {
    ...
    test.skipIf(process.env.JOB_SEARCH_LIVE_TESTS !== "1")("all valid flags produce no BAD_ARG", async () => {
      const result = await runCLI([
